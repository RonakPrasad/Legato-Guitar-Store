...
$sql = "INSERT INTO feedback (name, email,equipment ,comment)
VALUES ('$name', '$email', '$equipment', '$comment')";
...
<title>Feedback - Legato Guitar Store</title>
...
<a href="feedback.php">Feedback</a>
 <a href="javascript:void(0);" class="icon" onclick="myFunction()">
  ...
  </a><div class="search-container" style="margin-top:13px;">
    <div class="dropdown">
...
<div class="container1" style="margin-top:40px;margin-left:65px;margin-right:65px;">
  ...
  <span style="font-size:50px;"><center>YOUR FEEDBACK</center></span>
    ...
    <select  name="equipment">
      ...
      <option value="semi-acousticguitar">Semi-Acoustic Guitar</option>
      <option value="electricguitar">Electric Guitar</option>
	  <option value="bassguitar">Bass Guitar</option>
      <option value="amplifier">Amplifier</option>
	  <option value="more">More than one equipment</option>
    </select>
